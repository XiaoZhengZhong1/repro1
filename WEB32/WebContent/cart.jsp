...
<body>
	...
	<div class="container">
				...
				<c:forEach items="${cart.cartItems }" var="entry">
						...
						<tr class="active">
							...
							<td width="15%"><span class="subtotal">￥${entry.value.subtotal}</span></td>
													<!-- 为删除,添加一个事件方法,并把循环中本购物项的商品pid,传递到方法参数中 -->		
							<td><a href="javascript:;" onclick="delProFromCart('${entry.value.product.pid}')" class="delete">
							删除</a>
							</td>
						</tr>
		...
		<div style="margin-right: 130px;">
			...
			<div
				...
				<a href="javascript:;" onclick="clearCart()" id="clear" class="clear">
				清空购物车</a>
	...
	<c:if test="${empty cart.cartItems }">
			<div>
				<img alt="" src="${pageContext.request.contextPath }/images/aaa.png">
