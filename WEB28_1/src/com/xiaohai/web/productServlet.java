...
/*现在所有页面有关商品增删改查的请求都只找类,让本类继承BasicServlet类,请求就会到BasicServlet类,在类中获取请求的方法
参数,再用反射技术获取本类的方法名称,和之对比,相同就调用*/
...
public class productServlet extends BasicServlet {	
	...
	//本次演示点击具体的商城首页商品或者分类商品,显示具体的商品详细信息代码
	public void ProductInfo(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {

		//获取点击商品的分类cid 和 商品展示的当前也,以方便商品详细页面返回时需要的查询参数
		String cid = request.getParameter("cid");
	...
	// 本次演示动态获取商城首页商品分类,直接到数据库查询商品分类表所有商品分类,返回到访问页面
